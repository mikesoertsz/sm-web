...
export const InnerWrap = tw.div`container mx-auto max-w-7xl px-8 lg:px-0`;
...
export const Heading = tw.h2`text-5xl max-w-3xl mb-2 font-title`;
export const SubHeading = tw.h3`text-xl md:text-3xl font-thin md:text-3xl tracking-tight font-body max-w-3xl`;
